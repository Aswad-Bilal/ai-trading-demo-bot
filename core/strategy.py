...
def _result(signal, candles, timeframe, reasons, strength, trend, volatility, last):
    return {
        "signal": signal,
        "strength": strength,
...
def analyze_binary(candles: pd.DataFrame, timeframe: str):
    ...
    return _result(signal, candles, timeframe, reasons, strength, trend, volatility, last)
